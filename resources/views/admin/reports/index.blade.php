...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Rapports et statistiques</h1>
    </div>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Analyse des ventes</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Répartition des commandes</h6>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p class="mb-0">Les produits les plus populaires sur la plateforme.</p>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p class="mb-0">Dernières activités sur la plateforme.</p>
...
<script>
// Exemple de graphique (à personnaliser selon vos données)
