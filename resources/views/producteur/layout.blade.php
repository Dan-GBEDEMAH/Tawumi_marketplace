...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Producteur Dashboard - TawumiConfirm')</title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="text-center mb-4 p-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('producteur.orders*') ? 'active' : '' }}" href="{{ route('producteur.orders') }}">
                                <i class="fas fa-truck me-2"></i>Mes commandes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('producteur.reports*') ? 'active' : '' }}" href="{{ route('producteur.reports') }}">
